...
public class HyperLogLog {
    ...
    public static void main(String[] args) {
        ...
        hyperLogLog.offer("ccc1");
        hyperLogLog.offer("ccc2");
        hyperLogLog.offer("ccc3");
        hyperLogLog.offer("ccc5");
        hyperLogLog.offer("ccc4");
        hyperLogLog.offer("ccc6");
        hyperLogLog.offer("ccc7");
        hyperLogLog.offer("ccc9");
